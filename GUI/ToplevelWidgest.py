...
t1=Toplevel(root)
Label(t1, text='This is a child of root0').pack(padx=10, pady=10)
t2=Toplevel(root)
Label(t2,text='This is a trasciente window of root').pack(padx=10, pady=10)
t2.transient(root)
...
root.mainloop() #important to showt the GUI
